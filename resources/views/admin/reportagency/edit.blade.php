...
<div class="row">
    <div class="col-md-12">
        <div class="card card-primary">
            ...
            <form method="POST" action="{{ url('/6462/75726975') }}">
                @csrf
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col">
                            ...
                            <input type="number" class="form-control" id="report_week" placeholder="Report Week" name="report_week" required value="{{ $report_week }}">
                        </div>
                        @error('report_week')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
