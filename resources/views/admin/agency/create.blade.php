                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col">
                            ...
                            {{-- <input type="text" class="form-control" id="pic_idcard" placeholder="ID Card PIC" name="pic_idcard" required> --}}
                            <input type="text" pattern="\d*" maxlength="16" class="form-control" id="pic_idcard" placeholder="ID Card PIC" name="pic_idcard" required>
                        </div>
                        @error('pic_idcard')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col">
                            ...
                            {{-- <input type="text" class="form-control" id="pic_phone" placeholder="PIC Phone Number" name="pic_phone" required> --}}
                            <input type="text" pattern="^\+62\d{10,}$" title="Please enter a valid phone number starting with +62 and containing 10 or more digits." class="form-control" id="pic_phone" placeholder="PIC Phone Number" name="pic_phone" required>
                        </div>
                        @error('pic_phone')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
