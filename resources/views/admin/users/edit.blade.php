                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Name" name="name" value="{{ $name }}" required>
                        </div>
                        @error('name')
                        ...
                        <div class="form-group col">
                            ...
                            <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Email" name="email" value="{{ $email }}" required>
                        </div>
                        @error('email')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
