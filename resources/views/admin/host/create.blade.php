                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" id="host_uid" placeholder="Host UID" name="host_uid" required>
                        </div>
                        @error('host_uid')
                        ...
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" id="host_name" placeholder="Host Name" name="host_name" required>
                        </div>
                        @error('host_name')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="row">
                        <div class="form-group col">
                            <label>Agency</label>
                            <select class="form-control select2" style="width: 100%;" name="agency_id" required id="agency_id">
                                <option></option>
